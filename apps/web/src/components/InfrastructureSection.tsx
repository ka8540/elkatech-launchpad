    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left: image */}
          <StableReveal variant="card" className="relative">
            ...
            <div className="space-y-4">
              {features.map((feature, index) => (
                <StableReveal
                  key={feature.title}
                  variant="card"
                  delay={Math.min(0.18 + index * 0.06, 0.24)}
                  className="group relative isolate flex items-start gap-4 overflow-hidden rounded-xl border border-border bg-card p-4 transition-[border-color,box-shadow,background-color] duration-300 ease-out hover:border-blue-400/40 hover:shadow-[0_20px_70px_rgba(14,165,233,0.12)]"
                >
                  ...
                  <div className="relative z-10 w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center flex-shrink-0 transition-[background-color,box-shadow] duration-300 group-hover:bg-accent/20 group-hover:shadow-glow">
        ...
        <div className="mt-16">
          <StableReveal
            variant="card"
            className="relative isolate overflow-hidden rounded-3xl border bg-card p-6 md:p-8"
          >
            <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-blue-500/[0.08] via-transparent to-cyan-400/5 opacity-80" />
            <div className="relative z-10">
